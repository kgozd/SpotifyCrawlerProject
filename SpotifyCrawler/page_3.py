...
class Page3(Page):
    ...
    def create_widgets(self):
        ...
        self.textbox = CTkTextbox(self, width=420, height=300, font=("Arial", 20),fg_color="#2b2b2b", padx= 10, pady= 10, text_color="white")
        ...
        self.textbox.insert("end", f"{kropka} Opis:\nTa aplikacja służy do pobierania informacji o artystach, albumach i utworach ze Spotify, aby wydobyć te dane komunikauje się z API tego serwisu a następnie przetwarza i prezentuje je z pomocą tabel oraz wykresów.")
